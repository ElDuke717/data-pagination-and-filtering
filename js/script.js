...
/*
The showPage function will inserts/append the elements needed to display a "page" of nine students
*/
...
function searchPeople() {
   ...
   //    if (names[i].first.toLowerCase().includes(searchInput.toLowerCase()) ) {
